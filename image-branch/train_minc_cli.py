...
def parse_args():
    ...
    p.add_argument("--minc_root", type=str, default=r"F:\study\\LSMRT\data\\minc-2500")
...
def main():
    ...
    if train_list is None or val_list is None or test_list is None:
        raise FileNotFoundError("Cannot find train/validate/test txt files.")
    ...
    # tag_aug = "rrc" if args.strong_aug else "resize"
